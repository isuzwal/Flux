    ...
    <div className=" w-full py-8 ">
      ...
      <div className="w-full flex flex-col items-center gap-3.5 justify-center py-8">
        ...
        <div className="flex  justify-center">
          <div className=" flex gap-1 items-center border border-primary px-3 py-1">
            <Github className=" text-foreground/80 size-4.5" />{" "}
            <button className=" cursor-pointer text-[14px] font-sans font-medium  text-foreground/80  ">
              Star On Github
            </button>
          </div>
        </div>
